...
public class ImGuiScreen extends Screen {
    ...
    private final HashMap<Setting, Object> settingsMap = new HashMap<>();
    private final HashMap<Module.Category, Boolean> spaghettiCode = new HashMap<>();
    private final HashMap<Module, Boolean> showSettingsMap = new HashMap<>();
